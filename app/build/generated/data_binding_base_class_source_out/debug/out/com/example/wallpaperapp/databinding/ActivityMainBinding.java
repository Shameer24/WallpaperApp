...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout activityMain, @NonNull AppBarLayout appbarlayout,
      @NonNull RecyclerView recyclerHome, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, activityMain, appbarlayout,
          recyclerHome, toolbar);
    }
